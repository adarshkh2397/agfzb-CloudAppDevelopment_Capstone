...
cloudant_username = "9cfb4a73-3576-4c5e-a38e-ee884c379df0-bluemix"
cloudant_api_key = "HGI3hYZqZWtemYideIG3jWmOjUrck-0mgEA2NYpEyGal"
cloudant_url = "https://9cfb4a73-3576-4c5e-a38e-ee884c379df0-bluemix.cloudantnosqldb.appdomain.cloud"
...
def post_review():
    ...
    review_data_json = request.json
    review_data = review_data_json["review"]
    review_data['id'] = random.randint(100, 500)
